      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between">
          ...
          <nav className="hidden lg:flex items-center gap-7">
            <Link
              to="/"
              className={`text-xs font-semibold uppercase tracking-luxury transition-colors ${
                location.pathname === "/"
            ...
            >
              ...
              {servicesDropdownOpen && (
                <div className="absolute top-full left-1/2 -translate-x-1/2 w-[520px] bg-studio-ivory border border-studio-border shadow-elevated p-5 grid grid-cols-2 gap-4 animate-fadeIn">
